      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-kaia-red rounded-full hidden items-center justify-center text-white text-center p-6 shadow-xl md:flex">
              <p className="font-display text-3xl leading-tight">
                Est. 2012 <br /> in the Heart
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <span className="font-script text-3xl text-kaia-red">
              Our Story
            </span>
            <h2 className="text-6xl md:text-7xl font-display leading-tight text-kaia-charcoal">
              The Soul of <br />{" "}
              <span className="text-kaia-red">kaiapantry.</span>
            </h2>
            <div className="space-y-6 text-kaia-charcoal/80 font-light leading-relaxed text-lg">
              ...
              <p>
                ...
                bring back the authentic, unhurried taste of traditional pantry
                staples. Today, we continue that legacy with every loaf and cake
                we craft.
              </p>
              <p>
                We source our ingredients from local artisans and organic farms,
                ensuring that every bite is as wholesome as it is delicious.
              </p>
            </div>

            <div className="pt-6 grid grid-cols-2 gap-8 border-t border-kaia-tan">
              <div>
                <h4 className="font-display text-4xl mb-1 text-kaia-red">
                  100%
                </h4>
                <p className="text-[10px] uppercase tracking-widest text-kaia-taupe font-bold">
                  Organic Sourcing
                </p>
              </div>
              <div>
